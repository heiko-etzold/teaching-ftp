...
>
> + [Ziele der fachdidaktischen Tagespraktika](files/Zielkompetenzen2024.pdf) (siehe Abschnitt \@ref(ziele-der-ftp))
...
Für eine bessere Orientierung und zur Unterstützung Ihrer individuellen Entwicklung wurden im Praxisteam der Mathematikdidaktik an der Universitöt Potsdam noch einal spezifischere Ziele formuliert [→ zur pdf-Datei](files/Zielkompetenzen2024.pdf). Diese werden im Praktikum ausführlich gemeinsam besprochen und fortlaufend verfolgt.
...
Die Überlegungen zu allen vorherigen Elementen müssen Sie selbstverständlich durchführen, brauchen diese aber für die Vorbesprechung nicht ausführlich zu verschriftlichen. 
Weitere Hinweise finden sich im Anhang \@ref(vorbesprechung).
