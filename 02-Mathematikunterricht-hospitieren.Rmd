...
Die für die fachdidaktischen Tagespraktika empfohlenen Kategorien zur strukturierten Unterrichtsbeobachtung ([→ zur pdf-Datei](files/Beobachtungskategorien.pdf)) lehnen sich an die zuvor genannten Kriterien an und verfolgen insbesondere das Ziel, Bezüge zu den Vorlesungsinhalten der Einführung in die Mathematikdidaktik herzustellen -- v. a. unter dem Gesichtspunkt, dass es sich um die ersten Unterrichtsversuche der Studierenden handelt.  
Während die ersten beiden Kriterien eher **pädagogischer** Natur sind, folgen fünf Krtieren eher **didaktisch-methodischer** Natur sowie weitere fünf, die stärker auf **mathematikdidaktische Theorien** bezogen sind.
Diese Trennung ist jedoch nicht immer scharf und eine Zuordnung möglicher Inhalte nicht immer eindeutig -- so beeinflusst z. B. die gelebte Fehlerkultur auch das Lernklima, Visualisierungen können zum Verständnis beitragen, die Aufgabengestaltung ermöglicht differenzierenden Unterricht usw.

Die in der folgenden Aufzählung formulierten Kategorienbeschreibungen reichen in keinem Falle aus, die Kategorien inhaltlich durchdrungen zu haben.
Hierzu ist eine Beschäftigung mit den erwähnten Inhalten notwendig, wofür bei mathematikdidaktischen Bezügen auch mögliche Quellen angegeben sind.
